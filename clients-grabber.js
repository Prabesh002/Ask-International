...
const jsonFilePath = path.join(process.cwd(), 'JSON-datas', 'images.json');
...
async function UploadToServer(req, res) {
  try {
    ...
    const imagePath = path.join(process.cwd(), "uploads", uniqueFileName);
    ...
    console.log("Skipping the deletion")
